...
usage -auto -elapse
set log file fv/CIC/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root CIC -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/CIC/g1.v.gz
} else {
...
elaborate design -revised -root CIC
...
write hier_compare dofile fv/CIC/hier_rtl_to_g1.do \
...
run hier_compare fv/CIC/hier_rtl_to_g1.do -dynamic_hierarchy
