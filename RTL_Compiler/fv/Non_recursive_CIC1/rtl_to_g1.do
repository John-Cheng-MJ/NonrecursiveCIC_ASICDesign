...
usage -auto -elapse
set log file fv/Non_recursive_CIC1/rtl_to_g1.log -replace
tclmode
...
vpx read design   -define SYNTHESIS  -golden -lastmod -noelab -verilog2k \
	../Source/Non_recursive_CIC1_tc.v
} else {
...
elaborate design -golden -root Non_recursive_CIC1 -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/Non_recursive_CIC1/g1.v.gz
} else {
...
elaborate design -revised -root Non_recursive_CIC1
...
write hier_compare dofile fv/Non_recursive_CIC1/hier_rtl_to_g1.do \
...
run hier_compare fv/Non_recursive_CIC1/hier_rtl_to_g1.do -dynamic_hierarchy
